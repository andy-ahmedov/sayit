...
Подробная разбивка по `Silero` и `Piper`, официальные источники, ограничения и команды для self-check лежат в [docs/SYSTEM_REQUIREMENTS.md](/home/andy/github.com/andy-ahmedov/sayit/docs/SYSTEM_REQUIREMENTS.md).
...
Подробное описание возможностей, ограничений и сценариев запуска Silero находится в [docs/SILERO_CAPABILITIES.md](/home/andy/github.com/andy-ahmedov/sayit/docs/SILERO_CAPABILITIES.md).
...
Готовый пример лежит в [examples/silero.config.toml](/home/andy/github.com/andy-ahmedov/sayit/examples/silero.config.toml).
...
Готовый пример лежит в [examples/piper.config.toml](/home/andy/github.com/andy-ahmedov/sayit/examples/piper.config.toml).
...
- [piper.config.toml](/home/andy/github.com/andy-ahmedov/sayit/examples/piper.config.toml)
- [silero.config.toml](/home/andy/github.com/andy-ahmedov/sayit/examples/silero.config.toml)
- [config.example.toml](/home/andy/github.com/andy-ahmedov/sayit/examples/config.example.toml)
