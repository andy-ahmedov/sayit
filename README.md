...
Подробное описание возможностей, ограничений и сценариев запуска Silero находится в [docs/SILERO_CAPABILITIES.md](/home/andy/github.com/andy-ahmedov/speech/docs/SILERO_CAPABILITIES.md).
...
Готовый пример лежит в [examples/silero.config.toml](/home/andy/github.com/andy-ahmedov/speech/examples/silero.config.toml).
...
- [piper.config.toml](/home/andy/github.com/andy-ahmedov/speech/examples/piper.config.toml)
